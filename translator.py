# To run, use arguments in the command line, like so:
# python translator.py --text "This is some text to translate" --source-language-code en --target-language-code es
...
def main():
    # uses vars(), an inbuilt function which returns a dictionary object
